...
namespace PokemonUnity
{
	...
	public class TypingForm : UGuiForm
	{
		...
		private IEnumerator TypeWithKeyboard()
		{
			...
			{
				if (UnityEngine.Input.GetKeyDown(KeyCode.LeftShift) || UnityEngine.Input.GetKeyDown(KeyCode.RightShift) || UnityEngine.Input.GetKeyDown(KeyCode.CapsLock))
				{
					GameEntry.IsCapLockOn = !GameEntry.IsCapLockOn;
				}
				if (UnityEngine.Input.GetKeyUp(KeyCode.LeftShift) || UnityEngine.Input.GetKeyUp(KeyCode.RightShift))
				{
					GameEntry.IsCapLockOn = !GameEntry.IsCapLockOn;
				}
